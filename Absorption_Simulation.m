...
if strcmpi(core_material, 'sno2')
    ...
    Keff=5e3;                                   % effective anisotropy constant, 5-9e3 [3] J/m^2
    Ms=250e3;                                   % saturation magnetization, 250-300e3 [3] A/m
    ...
    c_ns=2.65e5;%8.3893e+20                     % number density [1/m^3]
...
c_ns = planar_density/(2*a);                % number density [1/m^3]
